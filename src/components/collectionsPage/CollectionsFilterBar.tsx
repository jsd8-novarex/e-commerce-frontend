...
function CollectionsFilterBar() {
  return (
    <section className='sticky top-[5rem] z-[2] col-start-1 col-end-13 flex items-center justify-end gap-x-8 bg-white/90 px-4 py-2 md:justify-between lg:top-[4.5rem] lg:col-start-2 lg:col-end-12 2xl:top-[4.75rem] 2xl:col-start-3 2xl:col-end-11'>
