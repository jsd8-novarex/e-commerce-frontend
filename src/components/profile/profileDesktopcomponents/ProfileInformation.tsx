...
// import { getCustomerProfile, Customer, updatePassword } from "../../../service/customerService";
...
//         id: customer._id, // Assuming `customer._id` is available
//         oldPassword,
//         newPassword,
//       });
...
//     // ตรวจสอบว่ารหัสผ่านเก่าตรงกับในฐานข้อมูล
//     const [isOldPasswordCorrect, oldPasswordError] = await verifyOldPassword({
//       id: customer._id,
//       oldPassword,
//     });

//     if (oldPasswordError || !isOldPasswordCorrect) {
...
//             name='date_of_birth'
//             value={
//               profileData.date_of_birth ? dayjs(profileData.date_of_birth).format("YYYY-MM-DD") : ""
//             }
//             onChange={handleProfileChange}
//             className='border p-2'
//           />
...
//             <p className='text-gray-600'>
//               <strong>Password</strong>: ********{" "}
//               <EditButton onClick={() => setIsEditingPassword(true)} label='Change Password' />
//             </p>
//           </div>
//           <div className='flex w-1/2 flex-col gap-y-2 border-l pl-6 text-gray-600'>
//             <p>
